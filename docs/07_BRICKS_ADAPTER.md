...
Phase 4 stops at faithful source HTML, CSS, dependencies, diagnostics, report,
and deterministic artifacts. It does not generate Design IR `1.0.0`, alter
TokenSet `1.0.0`, create a Hero LiveFrames component, generate HEEx, normalize
to Tailwind, add LiveView behavior, add Storybook catalogue content, or begin
Phase 5. Any source requirement that would force a change to either frozen
contract is reported as a later architectural issue rather than changed here.
